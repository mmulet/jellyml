...
def push_jelly_history(run: Run, jelly_history: JellyHistoryJSON, item: JellyHistoryItem):
    """
    Pushes an item to the jelly history.
    """
    with HistoryFd(run, "w") as history_fd:
        jelly_history["history_stack"].append(item)
